		...
		<nav className={styles.container}>
			<div className={styles.navigation}>
				...
				<div className={styles.burger_nav}>
					<BurgerMenu />
					<a className={`${showSearch ? styles.xs__hidden : ''}`} href='/'>
				...
				<div className={styles.buttons__section}>
					...
					>
						...
						>
							<path
							className={`${styles.searchIcon} ${
								showSearch ? styles.active : styles.inactive
							  }`}
					...
					<button className={styles.nav__buttons}>
						<img src={busketNav} alt='busket' />
					</button>
					<button className={styles.nav__buttons}>
						<img src={userNav} alt='user' />
					</button>
				</div>
			</div>
		</nav>
